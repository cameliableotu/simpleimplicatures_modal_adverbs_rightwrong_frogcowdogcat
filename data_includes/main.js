...
PennController("experiment" ,
    ...
    newCanvas(800, 350)
        ...
        .settings.add( 300 , 0 , getImage("dogshadowonedogonstage") )
        .print()
...
PennController("experiment" ,
    ...
    newCanvas(800, 350)
        ...
        .settings.add(480 , 0 , getImage("dogshadowtwodogsonstage") )
        .print()
...
PennController("experiment" ,
    ...
    newCanvas(800, 400)
        ...
        .settings.add(375, 0 , getImage("catshadowatwocatsonstage") )
        .print()
...
PennController("experiment" ,
    ...
    newCanvas(800, 350)
        ...
        .settings.add(300, 0 , getImage("cowshadowonecowonstage") )
        .print()
...
PennController("experiment" ,
    ...
    ,
    newCanvas(800, 500)
        .settings.add( 0 , 0 , getImage("twocows") )
        .settings.add( 475, 0 , getImage("cowshadowonecowonstage") )
        .print()
